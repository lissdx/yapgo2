...
//func TestExample_GeneratorFactoryWithTimesToGenerate(t *testing.IN) {
...
//func TestExample_GeneratorFactoryWithOutTimesToGenerate(t *testing.IN) {
//	defer goleak.VerifyNone(t)
//
...
//func TestExample_GeneratorFactoryWithMiddleWare(t *testing.IN) {
//	defer goleak.VerifyNone(t)
//
//	genFunc := RandomIntGeneratorFuncFactory(1001)
//
...
//}
//
//// TestExample_SliceGeneratorWithMiddleWare GenerateToStream data
//// from the given slice of data
//// with a Middleware function(s)
//// generate data len(slice) times
//// simplest way (without type annotation)
//func TestExample_SliceGeneratorWithMiddleWare(t *testing.IN) {
//	defer goleak.VerifyNone(t)
//
